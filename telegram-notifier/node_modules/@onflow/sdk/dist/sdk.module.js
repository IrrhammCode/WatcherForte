...
function createResolveCadence(context) {
  return async function resolveCadence(ix) {
    ...
    invariant$1(!isOldIdentifierSyntax(cadence, context.legacyContractIdentifiers) || !isNewIdentifierSyntax(cadence), "Both account identifier and contract identifier syntax not simultaneously supported.");
