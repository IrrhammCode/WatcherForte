import { AccountStatusEvent, Block, BlockDigest, BlockHeader, Event, TransactionExecutionStatus, TransactionStatus } from ".";
/**
 ...
 */
export type SubscriptionData<T extends SubscriptionTopic> = SubscriptionDataMap[T];
/**
 * Raw data returned by a subscription, which will vary depending on the topic and is not decoded
 */
export type RawSubscriptionData<T extends SubscriptionTopic> = RawSubscriptionDataMap[T];
/**
 * Arguments for a subscription, which will vary depending on the topic
 */
export type SubscriptionArgs<T extends SubscriptionTopic> = SubscriptionArgsMap[T];
/**
